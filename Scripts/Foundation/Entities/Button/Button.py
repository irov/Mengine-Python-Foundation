...
class Button(Interaction):
    ...
    def declareORM(Type):
        ...
        Type.addAction(Type, "TextID", Update=Button._updateTextID)
        Type.addAction(Type, "TextArgs", Update=Button._updateTextArgs)
        Type.addAction(Type, "TextPosition", Update=Button.__updateTextPosition)
        Type.addAction(Type, "TextPositionDown")
        Type.addAction(Type, "TextPositionOver")
        Type.addAction(Type, "TextAlign", Update=Button.__updateAlign)
        Type.addAction(Type, "TextVerticalAlign", Update=Button.__updateVerticalAlign)
        Type.addAction(Type, "TextLineOffset", Update=Button.__updateLineOffset)

        Type.addAction(Type, "Font", Update=Button._updateFont)
        Type.addAction(Type, "FontRGBA", Update=Button.__updateFontRGBA)

        Type.addAction(Type, "BlockState")
        Type.addAction(Type, "BlockKeys")
        Type.addAction(Type, "onUp")
        Type.addAction(Type, "onDown")
        Type.addAction(Type, "onOver")
        Type.addAction(Type, "KeyTag")
        Type.addAction(Type, "SoundTag")
        Type.addAction(Type, "SoundTagEnter")
        pass
