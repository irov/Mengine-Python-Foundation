...
# ----------------------------------------------------------------------------------------------------------------------
    ...
    def showInterstitialAdvert(placement):
        ...
        def __onSystemDialogClosed():
            Trace.msg("<DummyAdvertisement> interstitial system dialog closed")
            ...
            AdvertisementProvider.cbInterstitialRevenuePaid({"placement": placement, "revenue": revenue})
