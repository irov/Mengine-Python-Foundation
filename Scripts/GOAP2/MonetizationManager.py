...
from GOAP2.Utils import getCurrentPlatformParams, getCurrentPublisher, getCurrentBusinessModel
from GOAP2.Utils import isCollectorEdition
...
class MonetizationManager(Manager, CurrencyManager):
    ...
    def importComponents(module, names):
        from GOAP2.Utils import importType
